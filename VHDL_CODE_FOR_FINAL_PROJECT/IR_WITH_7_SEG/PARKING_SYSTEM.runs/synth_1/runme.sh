...
HD_PWD='C:/Users/Kashif/Desktop/HE PROJEKT/FINAL_PS/PARKING_SYSTEM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log IR_Sensor_to_Seven_Segment.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source IR_Sensor_to_Seven_Segment.tcl

...
HD_PWD='C:/Users/Kashif/Desktop/HE PROJEKT/FINAL_PS/PARKING_SYSTEM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log IR_Sensor_to_Seven_Segment.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source IR_Sensor_to_Seven_Segment.tcl -notrace
